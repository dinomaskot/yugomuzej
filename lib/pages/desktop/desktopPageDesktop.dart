...
class DesktopPageDesktop extends StatefulWidget {
  const DesktopPageDesktop({super.key});

  @override
  State<DesktopPageDesktop> createState() => _DesktopPageDesktopState();
}

class _DesktopPageDesktopState extends State<DesktopPageDesktop> {
  int index = 1;
  @override
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  CustomInkWell(
                                    onTap: () => context.go("/desktop/pictures"),
                                    child: Padding(
                                      padding: const EdgeInsets.only(right: 20),
                                      child: Row(
                                        children: [
                                          Text(
                                            loc.desktop.pictures,
                                  ...
                                  CustomInkWell(
                                    onTap: () => context.go("/desktop/screensaver"),
                                    child: Padding(
                                      padding: const EdgeInsets.only(right: 20),
                                      child: Row(
                                        children: [
                                          Text(
                                            loc.desktop.screensaver,
                                            style: const TextStyle(color: Globals.darkGrey, fontFamily: "ArialBlack", fontSize: 12),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.fromLTRB(10, 5, 0, 3),
                                  ...
                                  CustomInkWell(
                                    onTap: () => context.go("/desktop/icons"),
                                    child: Padding(
                                      padding: const EdgeInsets.only(right: 20),
                                      child: Row(
                                        children: [
