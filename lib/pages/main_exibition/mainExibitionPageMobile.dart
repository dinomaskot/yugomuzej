...
class MainExibitionPageMobile extends StatefulWidget {
  // final String id;
  // const MainExibitionPageMobile({super.key, required this.id});
  const MainExibitionPageMobile({super.key});

  @override
  State<MainExibitionPageMobile> createState() => _MainExibitionPageMobileState();
}

class _MainExibitionPageMobileState extends State<MainExibitionPageMobile> {
  int index = 1;
  @override
